    ...
    <el-main>
        ...
        <el-table :height="tableHeight" :data="tableList" border stripe>
            ...
            <el-table-column label="操作" align="center" width="250">
                <template #default="scope">
                    <el-button v-permission="['sys:userList:reset']" icon="Setting" type="success" size="default"
                        @click="resetPas(scope.row)">重置密码</el-button>
                    <el-button v-permission="['sys:userList:deletd']" icon="Delete" type="danger" size="default" @click="deleteBtn(scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页 -->
...
import { getListApi, stopUserApi, updatePasswordApi, deleteApi } from
    "@/api/wxuser/index";
