<template>
    <el-main style="padding: 15px 30px 20px 30px;">
        <el-button v-permission="['sys:menuList:add']" style="margin-bottom: 15px;" icon="Plus" type="primary" size="default" @click="addBtn">新增</el-button>
        <!-- 表格 -->
        <el-table :tree-props="{ children: 'children', hasChildren: 'hasChildren' }" row-key="menuId" :data="tableList"
            ...
            <el-table-column label="操作" align="center">
                <template #default="scope" width="120">
                    <el-button v-permission="['sys:menuList:edit']" icon="Edit" type="primary" size="default" @click="editBtn(scope.row)">编辑</el-button>
                    <el-button v-permission="['sys:menuList:delete']" icon="Delete" type="danger" size="default" @click="deletBtn(scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
    </el-main>
