    ...
    <el-main height="">
        <el-form :model="searchParm" ref="form" :inline="true" size="default">
            ...
            <el-form-item>
                ...
                <el-button v-permission="['sys:bannerList:add']" icon="Plus" type="primary" @click="addBtn">新增</el-button>
            </el-form-item>
        </el-form>
        <!-- 表格数据 -->
        <el-table :height="tableHeight" :data="tableList" border stripe>
            ...
            <el-table-column label="操作" align="center" width="220">
                <template #default="scope">
                    <el-button v-permission="['sys:bannerList:edit']" @click="editBtn(scope.row)" icon="Edit" type="primary" size="default">编辑</el-button>
                    <el-button v-permission="['sys:bannerList:delete']" @click="deleteBtn(scope.row)" icon="Delete" type="danger" size="default">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页 -->
