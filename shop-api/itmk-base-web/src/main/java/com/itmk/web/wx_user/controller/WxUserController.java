...
import com.itmk.web.login.entity.UpadateParm;
import com.itmk.web.wx_user.entity.ForgetParm;
...
public class WxUserController {
    ...
    public ResultVo getList(WxUserParm parm) {
        ...
        //构造查询条件
        QueryWrapper<WxUser> query = new QueryWrapper<>();
        query.lambda().like(StringUtils.isNotEmpty(parm.getPhone()),
                WxUser::getPhone, parm.getPhone())
